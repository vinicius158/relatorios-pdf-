...
<div class="container">
  ...
  <input type="email" class="form-control" placeholder="Informe seu email" aria-label="Username" aria-describedby="addon-wrapping" id = "email">
  </div>         
...
<p class = "txt"><a href = "login.php">Retornar</a></p>             
